function loadMenuItems() {
    ...
    xmlhttp.open("GET", "/v4/assets/menu-items.xml", true);
    xmlhttp.send();
}
function menuItems(xml) {
    ...
    txt = txt+'<div id="nav-button" onclick="modalOpen()"><img class="nav-img" src="/v4/img/open-nav-button.png"></div>'
